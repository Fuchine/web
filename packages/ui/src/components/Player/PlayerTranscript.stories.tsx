...
const SAMPLE: TranscriptLine[] = [
  ...
  { id: "c", idx: 2, tStartMs: 324_000, textOriginal: "毎朝川沿いを歩いています。", textTranslation: "Every morning, I walk along the river.", tokens: [
    { surface: "毎朝", reading: "まいあさ", romaji: "maiasa" },
    { surface: "川沿い", reading: "かわぞい", romaji: "kawazoi" },
    { surface: "を", reading: null, romaji: "wo" },
    { surface: "歩いて", reading: "あるいて", romaji: "aruite" },
    { surface: "います", reading: "います", romaji: "imasu" },
    { surface: "。", reading: null, romaji: null },
  ] },
