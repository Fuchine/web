...
import { AppShell, type NavItem } from "@fuchine/ui";
...
export function AppLayout({ account, reviewDue, activeKey, children }: AppLayoutProps) {
  ...
  const nav: NavItem[] = [
    { key: "home", label: "Home", icon: I.home, active: activeKey === "home", onSelect: () => router.push("/") },
    { key: "review", label: "Review", icon: I.review, badge: reviewDue || undefined, active: activeKey === "review", onSelect: () => router.push("/review") },
    { key: "settings", label: "Settings", icon: I.settings, active: activeKey === "settings", onSelect: () => router.push("/settings") },
